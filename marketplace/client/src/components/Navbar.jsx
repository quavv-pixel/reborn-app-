    ...
    <header className="border-b border-slate-200 dark:border-slate-800 sticky top-0 bg-white/90 dark:bg-slate-950/90 backdrop-blur z-10">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4 px-4 py-3">
        <Link to="/" className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">
          Reborn<span className="text-indigo-600 dark:text-indigo-400">Market</span>
        </Link>
        <div className="flex items-center gap-4 text-sm">
          ...
          {user && (
            <>
              ...
              <Link
                to="/listings/new"
                className="px-3 py-1.5 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-medium hover:bg-slate-800 dark:hover:bg-slate-100"
              >
                + Sell an item
              </Link>
            </>
